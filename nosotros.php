                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="c-content-feature-1 wow animate fadeInUp" style="visibility: visible; animation-name: fadeInUp; opacity: 1;">
                                ...
                                <p class="c-font-thin">LunaDeco fue creada con el objetivo de comercializar en el mercado nacional productos de decoración, artículos de peltre, poliresina, muebles, textiles y todo tipo de implementos decorativos para el hogar, provenientes principalmente de China, Indonesia, Malasia e India.</p>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="c-content-feature-1 wow animate fadeInUp" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp; opacity: 1;">
                                ...
                                <h3 class="c-font-uppercase c-font-bold">Objetivo</h3>
                                <p class="c-font-thin">Ofrecer productos de calidad a precios de fabricantes.<br><br>Hoy en día el Retail vende productos que compra a fabricantes para después vender a personas, esto hace que el producto sea más costoso para el cliente final. Usted al comprar directamente a fabricantes, ahorrará y obtendrá el mismo producto que en Retail.</p>
                            </div>
                        </div>
                        <div class="col-sm-4 c-card">
                            <div class="c-content-feature-1 wow animate fadeInUp" data-wow-delay="0.4s" style="visibility: visible; animation-delay: 0.4s; animation-name: fadeInUp; opacity: 1;">
                                ...
                                <h3 class="c-font-uppercase c-font-bold">Misión y Visión</h3>
                                <p class="c-font-thin">Nuestra misión es brindar la mayor satisfaccion a nuestros clientes con productos especiales, que permitan crear espacios y ambientes únicos a sus hogares.<br><br>Nuestra visión es convertirnos en el año 2022 en el principal proveedor de productos de decoración de peltre y poliresina del país.</p>
                            </div>
                        </div>
                    </div>
                </div> 
